# coding=utf-8
# Adapted from https://github.com/Farama-Foundation/D4RL-Evaluations/blob/master/brac/behavior_regularized_offline_rl/brac/utils.py
  ...
  with summary_writer.as_default():
    for key, val in info.items():
      if isinstance(
        ...
        tf0.compat.v2.summary.scalar(name=key, data=val, step=step)
